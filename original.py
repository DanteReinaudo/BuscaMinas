...
def Busca_Bombas(MatrizImagen,MatrizRandom,cantbombas,k,logotablero,logobomba,nivel):
    vidas=4
    liberadas=0
    while vidas>0 and liberadas!=(200-cantbombas):
        ...
        filaInvalida = True
        while filaInvalida:
            fila=input("Ingrese un numero de fila: ")
            if fila.isnumeric() == True:
                fila = int(fila)
                if fila > 20 or fila < 1:
                    print("Esa fila no existe.")
                else:
                    filaInvalida = False
            else:
                print("La fila ingresada no es un numero")
        
        columnaInvalida = True
        while columnaInvalida:
            columna=input("Ingrese un numero de columna: ")
            if columna.isnumeric() == True:
                columna = int(columna)
                if columna > 20 or columna < 1 :
                    print("Esa columna no existe.")
                else:
                    columnaInvalida = False
            else:
                print("La columna ingresada no es un numero")
                    ...
                    for j in range (19,21):
                        if MatrizRandom[i][j]!=logobomba:
                            if i==fila and j == columna:
                                ...
                                contador=contador+1
            elif fila==1 and columna!=1 and columna!=20:
                for i in range(1,3):
                    for j in range (columna-1,columna+2):
                        if MatrizRandom[i][j]!=logobomba:
                            if i==fila and j == columna:
                                ...
                                contador=contador+1
            elif fila==20 and columna!=1 and columna!=20:
                for i in range(19,21):
                    for j in range (columna-1,columna+2):
                        if MatrizRandom[i][j]!=logobomba:
                            if i==fila and j == columna:
                                ...
                                contador=contador+1
            elif columna==1 and fila!=1 and fila!=20:
                    ...
                    for j in range (1,3):
                        if MatrizRandom[i][j]!=logobomba:
                            if i==fila and j == columna:
                                ...
                                contador=contador+1
            elif columna==20 and fila!=1 and fila!=20:
                for i in range(fila-1,fila+2):
                    for j in range (19,21):
                        if MatrizRandom[i][j]!=logobomba:
                            if i==fila and j == columna:
